        ...
        <nav id="NavBar" class="navbar fixed-top navbar-expand-md navbar-dark bg-white shadow-sm" style="z-index: 3;">
            <div class="container justify-content-between" id="">
                ...
                <div class="d-flex input-group search-bar">
                    <input type="text" class="form-control" placeholder="Search" aria-label="Search" aria-describedby="basic-addon2" width="20">
                    <span class="input-group-text colored" id="basic-addon2"><i class="bi bi-search"></i></span>
                </div>
